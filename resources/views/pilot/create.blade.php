                        ...
                        <form action="{{ route('pilot.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" id="pilotType" name="pilotType">
                                </div>
                                <div class="col-md-8">
                                    @foreach($raids as $raid)
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body text-center">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="hidden" name="raid_{{ $raid->id }}" id="raid_tier_{{ $raid->id }}" value="">
                                                        <button class="btn" id="raid_tier_btn_{{ $raid->id }}"></button>
                                                    </div>
                                                    <div class="col-md-6">
